            ...
            html: `
              <div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:520px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08)">
                ...
                <div style="padding:28px">
                  ...
                  <a href="${process.env.PORTAL_URL || 'https://cx-challenge.vercel.app'}" style="display:inline-block;background:#0062DE;color:#fff;font-size:14px;font-weight:600;padding:12px 24px;border-radius:8px;text-decoration:none">Ir al portal →</a>
